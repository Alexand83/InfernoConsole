...
// Script per creare un'icona ICO veramente compatibile con Windows e macOS
function createCompatibleICO() {
  const icoPath = path.join(__dirname, '..', 'build', 'icon.ico');
  
  console.log('🎨 Creando icona ICO compatibile con Windows e macOS...');
  ...
  console.log('✅ Icona ICO compatibile creata:', icoPath);
