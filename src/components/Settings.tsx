          ...
          {activeTab === 'info' && (
            <div className="space-y-6">
              ...
              <div className="bg-dj-primary rounded-lg p-6 border border-dj-accent/20">
                <h2 className="text-xl font-dj font-bold text-white mb-4">{t('settings.appInfo')}</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-dj-secondary rounded-lg p-4 border border-dj-accent/20">
                    ...
                    <div className="space-y-2 text-sm text-dj-light/60">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-white">2024.12.19</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-white">Alessandro(NeverAgain)</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-dj-secondary rounded-lg p-4 border border-dj-accent/20">
                    ...
                    <UpdateChecker
                      ...
                      updateUrl={updateUrl}
                      onUpdateChecked={setLastUpdateCheck}
                    />
                  </div>
                </div>
              </div>
